// Homemade ODROID-GO based on ODROID-GO: https://wiki.odroid.com/odroid_go/odroid_go

// Target definition
#define RG_TARGET_NAME             "CUSTOM-OGO"
...
#define RG_GPIO_GAMEPAD_Y           ADC1_CHANNEL_0
